...
![20201027131316](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232322110-826384935.png)
...
![20201107141210](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232324266-1577697072.png)
**哈希表的扩展与收缩**
...
![20201120165728](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232339372-2048424982.png)
...
![20201120170641](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232339554-139724023.png)

如果这时主服务器向三个从服务器传播长度为33字节的数据，那么主服务器的复制偏移量将更新为10086+33=10119，而三个从服务器在接收到主服务器传播的数据之后，也会将复制偏移量更新为10119，如下图所示

![20201120170747](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232339732-441335542.png)
...
![20201120171043](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232339928-855939843.png)
...
![20201120171229](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232340196-1185510721.png)
...
![20201120171742](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232340391-261496626.png)
...
![20201121084911](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232343732-2030923974.png)
...
![20201120175242](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232340797-473209178.png)

因为是第一次连接，所以会进行**完整重同步**，从服务器发送SYNC指令，主服务器执行BGSAVE，并将RDB文件发送给从服务。发送后再将缓冲区中的数据发送给从服务器

![20201120175357](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232341034-1518461070.png)

完全重同步后，主从服务器的偏移量相同，此后开始**命令传播**过程

![20201120175428](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232341257-1517796566.png)

![20201120175455](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232341536-959748468.png)

命令传播过程中，**从服务器A与主服务器断开连接了**，但是主服务器依然在执行客户端发来的指令，依然进行着命令传播

![20201120175525](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232341767-1246868662.png)

从服务器A尝试重连主服务器，某个时刻成功连上了。但是**它需要确定连上的主服务器是不是之前的主服务器**

![20201120191548](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232341984-104912797.png)

确认是之前的主服务器后，开始**部分复制**操作

![20201120175130](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232340596-715445999.png)
...
![20201120192712](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232342206-1415652802.png)
...
![20201120194014](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232342457-465896510.png)
...
![20201120200325](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232342726-318118256.png)
...
![20201120200431](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232342982-2040425155.png)
...
![20201120200930](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232343244-664737192.png)

如果此期间server1重新上线了，那么**它会降级成为从服务器**

![20201120201001](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232343506-509609655.png)
...
![20201122104850](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232343908-1540495151.png)

![20201122104856](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232344109-1808773821.png)

Sentinel状态以及masters**字典**

![20201122104917](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232344320-121569300.png)
...
![20201122105405](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232344544-1476178957.png)

### 3、获取主服务器信息

Sentinel默认会以每十秒一次的频率，通过命令连接**向被监视的主服务器发送INFO命令**，并通过分析INFO命令的**回复**来获取主服务器的当前信息

![20201122110153](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232344801-1087574285.png)
...
![20201122110831](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232345047-195485670.png)
...
![20201122111758](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232345287-1827123677.png)

### 5、接收主从服务器的频道信息

当Sentinel与一个主服务器或者从服务器建立起**订阅连接**之后，Sentinel就会通过订阅连接，向服务器发送以下命令

![20201122111958](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232345495-1076405268.png)
...
![20201122112131](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232345650-1107796642.png)
...
![20201122112310](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232345839-236600421.png)
...
![20201122124243](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232346071-2097992027.png)
...
![20201122125242](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232346360-251557554.png)
...
![20201122130223](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232346578-1303345646.png)
...
![20201123095602](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232347690-1072735329.png)
...
![20201123095940](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232347905-1959522483.png)
...
![20201123101417](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232348114-612048300.png)

**结构**

![20201123101433](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232348324-671823833.png)
...
![20201123102913](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232348550-1827131118.png)
...
![20201123103628](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232348757-1645055363.png)
...
![20201123103819](https://img2022.cnblogs.com/blog/2950406/202208/2950406-20220809232348960-1802725361.png)